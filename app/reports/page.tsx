...
import { Plus, FileText, Search, Trash2, Eye, Edit, Calendar, User, X } from "lucide-react"
...
export default function ReportsListPage() {
  ...
  useEffect(() => {
    ...
    const delay = hasLoadedRef.current ? (dateSearch && !search ? 300 : 500) : 0
          ...
          <div className="relative flex-1">
            ...
            {dateSearch && (
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-[var(--color-grayscale-6)] hover:text-[var(--color-grayscale-4)] transition-colors z-20"
                title="Очистить дату"
              >
                <X className="h-4 w-4" />
              </button>
              ...
              >
                ...
                {deleteConfirm === report.id ? (
                  ...
                  <button
                    ...
                    className="mt-2 flex w-full items-center justify-center gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-400 transition-colors hover:bg-red-500/20 flex-shrink-0"
                  >
